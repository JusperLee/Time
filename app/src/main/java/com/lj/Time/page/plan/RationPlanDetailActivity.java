...
import com.lj.Time.contract.plan.IRationPlanDetailContract;
...
import com.lj.Time.presenter.plan.RationPlanDetailPresenterImpl;
import com.lj.Time.widget.SemicircleProgressView;
...
public class RationPlanDetailActivity extends BaseActivity implements IRationPlanDetailContract.View {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.edit:
                com.lj.Time.page.plan.EditPlanActivity.open(this, planId, 0);
                break;
        }
