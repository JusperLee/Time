package com.lj.Time.page.other;
...
public class AboutActivity extends AbsAboutActivity implements OnRecommendedClickedListener {
    ...
    protected void onItemsCreated(@NonNull Items items) {
        ...
        items.add(new Contributor(R.mipmap.mine_icon, "李凯", "Developer & Designer", "https://github.com/JusperLee"));

        items.add(new Category("Open Source Licenses"));
        items.add(new License("ShiZhong", "LIKAI", License.APACHE_2, "https://github.com/JusperLee/Time"));
    }
