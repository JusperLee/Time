...
public class ApplicationInfoUtil {
     ...
     * 获取手机所有应用信息
     */
    public static List<com.lj.Time.db.ApplicationInfo> getAllProgramInfo(Context context) {
        List<com.lj.Time.db.ApplicationInfo> list = new ArrayList<>();
     ...
     */
    public static void getAllProgramInfo(List<com.lj.Time.db.ApplicationInfo> applist,
        ...
        for (int i = 0; i < packages.size(); i++) {
            ...
            com.lj.Time.db.ApplicationInfo tmpInfo = new com.lj.Time.db.ApplicationInfo();
     ...
     * 获取所有系统应用信息
     */
    public static List<com.lj.Time.db.ApplicationInfo> getAllSystemProgramInfo(Context context) {
        List<com.lj.Time.db.ApplicationInfo> systemAppList = new ArrayList<com.lj.Time.db.ApplicationInfo>();
     ...
     * 获取所有非系统应用信息
     */
    public static List<com.lj.Time.db.ApplicationInfo> getAllNoSystemProgramInfo(Context context) {
        List<com.lj.Time.db.ApplicationInfo> noSystemAppList = new ArrayList<com.lj.Time.db.ApplicationInfo>();
